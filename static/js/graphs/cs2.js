queue()
    ...
    .await(makeGraphs);
        ...
        show_cs_successful_motions (ndx);

        dc.renderAll();
    } 
    
    function show_cs_successful_motions (ndx) {
    var dim = ndx.dimension(dc.pluck('Successful')); 
    var group = dim.group().reduceSum(dc.pluck("Caroline Dwane Stanley"));
        
    dc.barChart("#cs-graph2") 
        .width(430)
        .height(300)
