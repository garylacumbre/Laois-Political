queue()
    ...
    .await(makeGraphs);
        ...
        show_amoran_successful_motions (ndx);

        dc.renderAll();
    } 
    
    function show_amoran_successful_motions (ndx) {
    var dim = ndx.dimension(dc.pluck('Successful')); 
    var group = dim.group().reduceSum(dc.pluck("Aisling Moran"));
        
    dc.barChart("#amoran-graph2") 
        .width(430)
        .height(300)
